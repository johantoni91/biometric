				...
				<div class="col-span-3">
					...
					<select
						...
						<option value="superadmin"
							{{ ($user->role || old("role")) == "superadmin" ? "selected" : "" }}>Superadmin</option>
						<option value="admin"
							{{ ($user->role || old("role")) == "admin" ? "selected" : "" }}>Admin</option>
						<option value="pegawai"
							{{ ($user->role || old("role")) == "pegawai" ? "selected" : "" }}>Pegawai</option>
					</select>
					@error("role")
						<small class="text-red-500">{{ $message }}</small>
					@enderror
